...
Welcome to **CraveGo**, an enterprise-grade, multi-tier food delivery application engineered for performance, security, and exceptional user experience. CraveGo features a complete commercial food ordering flow matching industry standards, built with a robust Node.js backend and a highly interactive React frontend.
...
*   🔒 **Secure Login & Route Guard**: Multi-tenant access control that protects sensitive pages (checkout, order history) with seamless return URL logic and robust backend security.
...
1.  **Clone the Repository**:
    ...
    ```
2.  **Database Setup**: 
    Import your database schema into your MySQL server.
3.  **Backend Configuration**: 
    Configure your environment variables in the backend directory (e.g., database credentials, AWS keys).
4.  **Run the Project**: 
    Start the Node.js backend and the React frontend development servers.
